...
use iu::{VelloPlugin, prelude::*};
use std::ops::DerefMut;

//const EMBEDDED_FONT: &str = "embedded://upd/assets/fonts/Inter/extras/otf/Inter-Regular.otf";
const EMBEDDED_FONT: &str = "embedded://upd/assets/fonts/Inter/InterVariable.ttf";
const EMBEDDED_FONT_ITALIC: &str = "embedded://upd/assets/fonts/Inter/InterVariable-Italic.ttf";
...
pub fn _main() {
    ...
    //  app.add_systems(Startup, (setup_gizmos, setup_scene))
    //      .add_systems(Update, (animation, run_gizmos));

    app.init_resource::<AnimationToggles>()
        .add_systems(
            Startup,
    ...
    //embedded_asset!(app, "assets/fonts/Inter/extras/otf/Inter-Regular.otf");
    embedded_asset!(app, "assets/fonts/Inter/InterVariable.ttf");
    embedded_asset!(app, "assets/fonts/Inter/InterVariable-Italic.ttf");
...
fn setup_worldspace_text(mut commands: Commands, asset_server: ResMut<AssetServer>) {
    ...
    commands.spawn((
        VelloText2d {
            ...
            text_align: VelloTextAlign::Justify,
