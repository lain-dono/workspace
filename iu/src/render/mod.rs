...
pub(crate) use self::plugin::VelloRenderPlugin;
...
pub(crate) enum VelloWorldRenderItem {
    Scene {
        affine: Affine,
        item: crate::scene::render::ExtractedVelloScene2d,
    },
    Text {
        affine: Affine,
        item: crate::text::render::ExtractedVelloText2d,
    },
}
...
pub(crate) enum VelloUiRenderItem {
    Scene {
        affine: Affine,
        item: crate::scene::render::ExtractedUiVelloScene,
    },
    Text {
        affine: Affine,
        item: crate::text::render::ExtractedUiVelloText,
    },
}
