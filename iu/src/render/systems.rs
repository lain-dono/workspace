...
use crate::{
    ...
    scene::render::{ExtractedUiVelloScene, ExtractedVelloScene2d},
    text::{
        VelloFont,
...
pub fn sort_render_items(
    ...
    view_world_text: Query<(&PreparedAffine, &ExtractedVelloText2d)>,
    view_ui_text: Query<(&PreparedAffine, &ExtractedUiVelloText)>,
