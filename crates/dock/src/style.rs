use egui::{
    self, CornerRadius, Margin, Stroke,
    ecolor::{Color32, tint_color_towards},
};
...
pub struct ButtonsStyle {
    /// Close tab button's.
    pub close_tab: ButtonStyle,

    /// Left or right aligning of the add tab button.
    pub add_tab_align: TabAddAlign,

    /// Add tab button's.
    pub add_tab: ButtonStyle,

    /// Close all tabs button's
    pub close_all_tabs: ButtonStyle,

    /// Collapse tabs button's.
    pub collapse_tabs: ButtonStyle,

    /// Minimize window button's.
    pub minimize_window: ButtonStyle,
}
...
pub struct ButtonStyle {
    ...
    pub bg_fill: Color32,
    /// Color of the button's left border.
...
impl Default for Style {
    fn default() -> Self {
        Self {
            ...
            main_surface_border_stroke: Stroke::new(0.0, Color32::BLACK),
...
impl Default for ButtonsStyle {
    fn default() -> Self {
        let btn = ButtonStyle {
            color: Color32::WHITE,
            active_color: Color32::WHITE,
            bg_fill: Color32::GRAY,
            border_color: Color32::BLACK,

            disabled_color: Color32::LIGHT_GRAY,
        };
        Self {
            close_tab: btn,
...
impl Default for OverlayStyle {
    fn default() -> Self {
        Self {
            selection: Stroke::new(1.0, Color32::from_rgb(0, 191, 255).linear_multiply(0.5)),
            button_spacing: 10.0,
            max_button_size: 100.0,

            surface_fade_opacity: 0.1,

            hovered_leaf_highlight: LeafHighlighting::default(),
...
impl ButtonsStyle {
    ...
    pub fn from_egui(style: &egui::Style) -> Self {
        let btn = ButtonStyle {
            bg_fill: style.visuals.widgets.hovered.bg_fill,
            color: style.visuals.text_color(),
            active_color: style.visuals.strong_text_color(),
            border_color: style.visuals.widgets.noninteractive.bg_fill,
            disabled_color: style.visuals.widgets.inactive.bg_fill,
        };
        Self {
            close_tab: btn,
            add_tab: btn,
...
impl OverlayStyle {
    ...
    pub fn from_egui(style: &egui::Style) -> Self {
        Self {
            selection: Stroke::new(1.0, style.visuals.selection.bg_fill.linear_multiply(0.5)),
